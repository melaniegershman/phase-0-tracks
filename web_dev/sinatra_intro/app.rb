...
get '/address' do
  "804 Grand St,<br>Brooklyn, NY<br>"  
end
...
# 3. A route that uses route params to add 2 numbers and respond with a result.
get '/add/:x/:y' do
    x = params[:x].to_i
    y = params[:y].to_i
    sum = x + y
...
#4. A search route to find a student using a query parameter
